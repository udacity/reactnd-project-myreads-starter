...
import {BookShelfComponent} from './components'
            ...
            <div className="list-books-content">
              <div>
                <div className="bookshelf">
                  ...
                  <BookShelfComponent books={booksReading} />
                </div>
                <div className="bookshelf">
                  <h2 className="bookshelf-title">Want to Read</h2>
                  <BookShelfComponent books={booksWantToRead} />
                </div>
                <div className="bookshelf">
                  <h2 className="bookshelf-title">Read</h2>
                  <BookShelfComponent books={booksRead} />
                </div>
              </div>
            </div>
