    ...
    return (
      <div className="app">
        <Route exact path='/search' render={() => {
          return <SearchPage searchList={mergeList} updateBook={this.updateBook} searchBooks={this.searchBooks} />
        }} />
        <Route exact path='/' render={() => {
          return <MainPage books={this.state.books} updateBook={this.updateBook} clearSearch={this.clearSearch} />
        }} />
