          ...
          <div className="search-books">
            <div className="search-books-bar">
              ...
              <div className="search-books-input-wrapper">
                {/* 
                  NOTES: Remember that the search from BooksAPI is limited to a particular set of search terms.
                  You can find these search terms here:
                  https://github.com/udacity/reactnd-project-myreads-starter/blob/master/SEARCH_TERMS.md
                  
                  However, BooksAPI.search method DOES search by title or author. So, don't worry if
                  you don't find an specific author or title. Everything is limited by the search terms.
                */}
