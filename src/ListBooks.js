...
class SearchBooks extends Component {
  ...
  updateBookshelfTitle = (book) => {
    let bookIndex = this.state.books.findIndex((b) => (
      b.id === book.id
    ))
    let newBooks = this.state.books;
    newBooks[bookIndex].bookshelf_title = 'Read'
    ...
    console.log('updateBookshelfTitle');
    this.state.books.map((book) => console.log(book.id + ' ' + book.bookshelf_title))
